...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.fetchCovidOverview(completionHandler: { [weak self] result in
            ...
            case let .success(result):
                ...
                let covidOverviwList = self.makeCovidOverviewList(cityCovidOverview: result)
                self.configureChartView(covidOverviewList: covidOverviwList)
    ...
    func fetchCovidOverview(
        ...
        let param = [
            "serviceKey" : "PpK6zvHQJAhqy5TYRf1dsSj9IiMtrowWB"
        ]
